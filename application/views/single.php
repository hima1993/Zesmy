...
<!-- //js -->
<!-- single -->
<script src="<?php echo base_url()?>template/js/imagezoom.js"></script>
				...
				<div class="flexslider">
					...
					<ul class="slides">
						<li data-thumb="images/d2.jpg">
							<div class="thumb-image"> <img src="<?php echo base_url() ?>template/images/d2.jpg" data-imagezoom="true" class="img-responsive"> </div>
						</li>
						<li data-thumb="images/d1.jpg">
							<div class="thumb-image"> <img src="<?php echo base_url() ?>template/images/d1.jpg" data-imagezoom="true" class="img-responsive"> </div>
						</li>	
						<li data-thumb="images/d3.jpg">
							<div class="thumb-image"> <img src="<?php echo base_url() ?>template/images/d3.jpg" data-imagezoom="true" class="img-responsive"> </div>
						</li>
						<li data-thumb="images/d4.jpg">
							<div class="thumb-image"> <img src="<?php echo base_url() ?>template/images/d4.jpg" data-imagezoom="true" class="img-responsive"> </div>
						</li>	
					</ul>
					<div class="clearfix"></div>
				</div>	
								...
								<div class="bootstrap-tab-text-grids">
									<div class="bootstrap-tab-text-grid">
										<div class="bootstrap-tab-text-grid-left">
											<img src="<?php echo base_url() ?>template/images/men3.jpg" alt=" " class="img-responsive">
										</div>
