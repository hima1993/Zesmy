						...
						<div class="col-md-3 product-men" id="abc">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="'.base_url().'template/images/'.$row->image1.'" alt="" class="pro-image-front">
									<img src="'.base_url().'template/images/'.$row->image1.'" alt="" class="pro-image-back">
										<div class="men-cart-pro">
											<div class="inner-men-cart-pro">
												<a href="'.site_url('Product').'" class="link-product-add-cart">Quick View</a>
											</div>
										</div>
										<span class="product-new-top">New</span>																			
								</div>
								<div class="item-info-product ">
									<h4><a href="single.html">'.$row->itemName.'</a></h4>
